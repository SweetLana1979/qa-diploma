...
**Негативные тесты (ввод невалидных данных)**
...
Ожидаемый результат: ответ от сервера - 200 ok, статус карты - APPROVED, сумма - 4 500 000
...
Ожидаемый результат: ответ от сервера - 200 ok, статус карты - APPROVED

_1.3.3. Покупка по неактивной карте (со статусом DECLINED)_
1. Обращаемся к URL-адресу [http://localhost:8080/api/v1/pay](http://localhost:8080/api/v1/pay)

Ожидаемый результат: ответ от сервера - 200 ok, статус карты - DECLINED
